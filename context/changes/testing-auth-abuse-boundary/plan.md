...
- [ ] 1.1 New signin test passes and `npm test` is green
- [ ] 1.2 Typecheck passes (`npm run typecheck`)
- [ ] 1.3 Lint passes (`npm run lint`)

#### Manual

- [ ] 1.4 Code review confirms all four branches + real cross-branch identical-response assertion
